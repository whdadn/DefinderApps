package com.dicoding.definderapps.ui.component.personality
...
@Composable
fun PersonalityItemPreview()
{
    PersonalityItem(name= "Candi Borobudur", imageUrl = "candi_borobudur", location = "Magelang", rating = "4 (120)", favorite = false, favoriteChange = {})
}